...
import { Building2, CalendarCheck2, ClipboardCheck, Droplet, Droplets, HandHeart, HeartPulse, Mail, MapPin, Phone, Search, ShieldCheck, Target, Users, } from "lucide-react";
export default function About() {
    return (<PageWrap className="max-w-6xl">
      {/* Mission */}
      ...
      <section className="mt-20">
        ...
        ].map((s, i) => (<Reveal key={s.title} delay={i * 0.07}>
      ...
      <section className="mt-20 grid items-center gap-8 lg:grid-cols-2">
        ...
        ].map((r) => (<li key={r} className="flex items-start gap-2.5 rounded-2xl bg-muted px-4 py-2.5">
      ...
      {/* Safety */}
      <section className="mt-20">
        <SectionHeading eyebrow="Safety First" title="Is donating blood safe?" subtitle="Absolutely — when done at licensed blood banks and camps, using sterile, single-use equipment."/>
        ...
        ].map((c, i) => (<Reveal key={c.title} delay={i * 0.07}>
              <div className="clay-card h-full p-6">
